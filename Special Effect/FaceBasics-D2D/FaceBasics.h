...
private:
	...
	HRESULT GetScreenshotFileName(_Out_writes_z_(nFilePathSize) LPWSTR lpszFilePath, UINT nFilePathSize, int i);
	...
	DepthSpacePoint*       m_color2depthLUT;

    // Color reader
    IColorFrameReader*     m_pColorFrameReader;

	// Depth frame reader - DH
