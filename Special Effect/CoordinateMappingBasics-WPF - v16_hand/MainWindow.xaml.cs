                           ...
                           float min_y = 0;
                                ...
                                ((bodyIndexWidth * bodyIndexHeight) == this.bodyIndexFrameData.Length))
                            {
                                ...
                                for (int y = (int)Math.Floor(min_y); y <max_y; ++y)
                                {
                                    ...
                                    if (label3==0)
                                    {
                                        if(y>((2*min_y+1*max_y)/3))
                                        {
                                            a=min_x+(max_x-min_x)*(y-(1*max_y+2*min_y)/3)/(max_y-min_y);
                                        }
                                        if (y< (( 2*min_y + 1*max_y) / 3))
                                        {
                                            b = max_x - (max_x - min_x) * ((2*max_y + 1*min_y) / 3 - y) / (max_y - min_y);
                                        }
                                    }
                                    else
                                    {
                                        if (y < ((1*min_y + 2*max_y) / 3))
                                        {
                                            a = min_x + (max_x - min_x) * (-y +(2*max_y + 1*min_y) /3) / (max_y - min_y);
                                        }
                                        if (y >((2*min_y +1* max_y) / 3))
                                        {
                                            b = max_x - (max_x - min_x) * (-(1*max_y +2* min_y) /3 + y) / (max_y - min_y);
                                        }
                                    }
                                    ...
                                    /*
                                        if (label3 == 0)
                                        {
                                            if (y > ((1 * min_y + 1 * max_y) / 2))
                                            {
                                                a = min_x + (max_x - min_x) * (y - (1 * max_y + 1 * min_y) / 2) / (max_y - min_y);
                                            }
                                            if (y < ((min_y + 1 * max_y) / 2))
                                            {
                                                b = max_x - (max_x - min_x) * ((1 * max_y + 1 * min_y) / 2 - y) / (max_y - min_y);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    */
                                    for (int x = (int)Math.Floor(a); x < b; ++x)
                                    {
